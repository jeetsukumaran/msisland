...
project_init = _read(["src", "msisland", "__init__.py"])
...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "msisland = msisland.application.msisland:main",
        ]
    },
    ...
    package_data={
        ...
        "msisland": [
            ...
            # For files located in 'src/msisland-data/'
            # "../msisland-data/*.json",
    ...
    test_suite = "tests",
    # url="http://pypi.python.org/pypi/msisland",
    url="https://github.com/jeetsukumaran/msisland",
    license="LICENSE",
